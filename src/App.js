...
class App extends React.Component {
  ...
  componentDidMount() {
    ...
    navigator.geolocation.getCurrentPosition(
      (position) => {
        ...
        axios
          .get(
            `https://api.openweathermap.org/data/2.5/weather?lat=${this.state.coords.latitude}&lon=${this.state.coords.longitude}&units=metric&appid=e51d73d6520a0d8c397192ddcface8ab`
          )
          .then((res) => {
            // console.log(res);
  ...
  onCityChange = (e) => {
    ...
    if (cityInput !== '') {
      ...
      axios
        .get(
          `https://api.openweathermap.org/data/2.5/weather?q=${cityInput}&units=metric&appid=e51d73d6520a0d8c397192ddcface8ab`
        )
        .then((res) => {
          // console.log(res);
